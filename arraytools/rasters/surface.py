...
http://matplotlib.org/examples/specialty_plots/topographic_hillshading.html

https://blogs.esri.com/esri/arcgis/2015/05/21/take-your-terrain-mapping-to/
-new-heights/

http://gis.stackexchange.com/questions/146296/how-to-create-composite-hillshade

https://github.com/Blarghedy/TerrainGen-Python

http://vterrain.org/Elevation/Artificial/

http://geogratis.gc.ca/site/eng/extraction?id=2016_56ae834dd24892.15336554
...
def slope_a(a, cell_size=1, degrees=True, verbose=False, keepdims=False):
    ...
    - c ell_size : must be in the same units as X and Y
